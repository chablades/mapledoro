...
export const BOSSES: Boss[] = [
  { name: "Hilla (Hard)", icon: icon("3"), meso: 56250000, preset: ["cra", "akechi", "nlomien"] },
  { name: "Pink Bean (Chaos)", icon: icon("11"), meso: 64000000, preset: ["cra", "akechi", "nlomien"] },
  { name: "Cygnus (Easy)", icon: icon("12"), meso: 45562500, shared: ["Cygnus (Normal)"] },
  { name: "Cygnus (Normal)", icon: icon("12"), meso: 72250000, shared: ["Cygnus (Easy)"], preset: ["cra", "akechi", "nlomien"] },
  { name: "Crimson Queen (Chaos)", icon: icon("6"), meso: 81000000, preset: ["cra", "akechi", "nlomien"] },
  { name: "Von Bon (Chaos)", icon: icon("5"), meso: 81000000, preset: ["cra", "akechi", "nlomien"] },
  { name: "Pierre (Chaos)", icon: icon("4"), meso: 81000000, preset: ["cra", "akechi", "nlomien"] },
  { name: "Zakum (Chaos)", icon: icon("1"), meso: 81000000, preset: ["cra", "akechi", "nlomien", "ctene"] },
  { name: "Princess No", icon: icon("18"), meso: 81000000, preset: ["cra", "akechi", "nlomien", "ctene"] },
  { name: "Magnus (Hard)", icon: icon("10"), meso: 95062500, preset: ["cra", "akechi", "nlomien", "ctene", "ekalos"] },
  { name: "Vellum (Chaos)", icon: icon("7"), meso: 105062500, preset: ["cra", "akechi", "nlomien", "ctene", "ekalos"] },
  { name: "Papulatus (Chaos)", icon: icon("22"), meso: 132250000, preset: ["akechi", "nlomien", "ctene", "ekalos"] },
  ...
  { name: "Guardian Angel Slime (Chaos)", icon: icon("29"), meso: 600578125, shared: ["Guardian Angel Slime (Normal)"], preset: ["ctene", "ekalos"] },
  { name: "Lucid (Easy)", icon: icon("19"), meso: 237009375, shared: ["Lucid (Normal)", "Lucid (Hard)"] },
  { name: "Lucid (Normal)", icon: icon("19"), meso: 253828125, shared: ["Lucid (Easy)", "Lucid (Hard)"] },
  { name: "Lucid (Hard)", icon: icon("19"), meso: 504000000, shared: ["Lucid (Easy)", "Lucid (Normal)"], preset: ["ctene", "ekalos"] },
  { name: "Will (Easy)", icon: icon("23"), meso: 246744750, shared: ["Will (Normal)", "Will (Hard)"] },
  { name: "Will (Normal)", icon: icon("23"), meso: 279075000, shared: ["Will (Easy)", "Will (Hard)"] },
  { name: "Will (Hard)", icon: icon("23"), meso: 621810000, shared: ["Will (Easy)", "Will (Normal)"], preset: ["ctene", "ekalos"] },
  { name: "Gloom (Normal)", icon: icon("26"), meso: 297675000, shared: ["Gloom (Chaos)"] },
  { name: "Gloom (Chaos)", icon: icon("26"), meso: 563945000, shared: ["Gloom (Normal)"], preset: ["ctene", "ekalos"] },
  { name: "Darknell (Normal)", icon: icon("27"), meso: 316875000, shared: ["Darknell (Hard)"] },
  { name: "Darknell (Hard)", icon: icon("27"), meso: 667920000, shared: ["Darknell (Normal)"], preset: ["ctene", "ekalos"] },
  { name: "Verus Hilla (Normal)", icon: icon("24"), meso: 581880000, shared: ["Verus Hilla (Hard)"] },
  { name: "Verus Hilla (Hard)", icon: icon("24"), meso: 762105000, shared: ["Verus Hilla (Normal)"], preset: ["ctene", "ekalos"] },
  { name: "Chosen Seren (Normal)", icon: icon("28"), meso: 889021875, shared: ["Chosen Seren (Hard)", "Chosen Seren (Extreme)"] },
  { name: "Chosen Seren (Hard)", icon: icon("28"), meso: 1096562500, shared: ["Chosen Seren (Normal)", "Chosen Seren (Extreme)"], preset: ["ekalos"] },
  { name: "Chosen Seren (Extreme)", icon: icon("28"), meso: 4235000000, shared: ["Chosen Seren (Normal)", "Chosen Seren (Hard)"] },
  { name: "Kalos the Guardian (Easy)", icon: icon("30"), meso: 937500000, shared: ["Kalos the Guardian (Normal)", "Kalos the Guardian (Chaos)", "Kalos the Guardian (Extreme)"], preset: ["ekalos"] },
