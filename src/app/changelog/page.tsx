...
const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    changes: [
      ...
      { type: "changed", text: "The Star Force Calculator now runs its simulation when you press Run Simulation, instead of rerunning on every change." },
      { type: "added", text: "The Star Force Calculator now warns you before an expensive run, shows progress while it works, and lets you stop it." },
      { type: "changed", text: "The Star Force Calculator target star can no longer be set at or below your current star." },
      { type: "changed", text: "The Star Force Calculator Enhancement Mode now reads Tier 1 to Tier 4 instead of 1x to 4x." },
      { type: "fixed", text: "Fixed the Star Force Calculator Trials field snapping back to 1000 when you tried to clear it." },
      { type: "fixed", text: "The Star Force Calculator destroy chance now shows 0% instead of a dash when an item cannot boom." },
      { type: "fixed", text: "The Star Force Calculator distribution chart is now readable by screen readers, and its tooltip follows your theme." },
    ],
  },
  {
    date: "2026-07-09",
