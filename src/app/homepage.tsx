...
const themes: Record<string, Theme> = {
  ...
  yuki: {
    name: "Yuki", emoji: "🐰",
    // soft white bg from her fur/hair, warm peach-orange from her hair tips,
    // navy from her scarf, pastel watercolor feel throughout
    bg: "#faf8f9",           // near-white with a faint blush warmth
    panel: "#ffffff",
    border: "#eedde6",       // soft pinkish border
    text: "#2a1e24",         // deep warm almost-black
    muted: "#a88898",        // muted dusty rose
    accent: "#d4607a",       // warm rosy pink (drawn from her hair gradient)
    accentSoft: "#fceef2",   // whisper pink
    accentText: "#b84060",
    sidebar: "#fdf5f8",
    sidebarAccent: "#d4607a",
    timerBg: "#fdf8fa",
    badge: "#e8d5e0",        // dusty lavender-pink badge
    badgeText: "#7a4060",
  },
};
