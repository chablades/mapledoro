...
// MASTERY_BASE_PERCENT.
{
  const lines = [
    ...
    `// Magic ATT) feeds TotalJobATT. Sourced from maplestorywiki.net/w/Damage_Formula and`,
    `// cross-checked against strategywiki, not derived from the skill manifest (no formula source`,
    `// exists for this). See gen-stat-baselines.mjs for the Xenon correction and other notes.`,
